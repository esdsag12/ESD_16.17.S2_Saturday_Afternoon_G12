...
public class LearningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listHeader.add("Short vowels");
        listHeader.add("Long vowels");
        listHeader.add("Double vowel sounds");
        listHeader.add("Voiced consonants");
        ...
        mData.put(listHeader.get(1), listLongVowel);
